package com.vinod.sqlitedatabaseapp.dbaccess.first;
...
public class SimpleDatabaseAccess extends SQLiteOpenHelper {
    ...
    public SimpleDatabaseAccess(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
